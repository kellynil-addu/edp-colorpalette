...
function generatePalette() {
    ...
    const primary = {
        h: Math.floor(Math.random() * 18), // Colors of the wheel
        s: 70 + Math.floor(Math.random() * 30), // Saturatiton [70-100]
        v: 70 + Math.floor(Math.random() * 30) // Value [70-100]
    }
...
function hsvToHex(h, s, v) {
    ...
    // How to make it whiter? Add more R, G, B.
    ...
    // How to make it blacker? Muliply by a decimal (ex: 0.5)
